...
mech.link(1)=createmechobject('link','r',0,0,a2,'theta12',1,'g',silent,2,labels{lblidx(2)},labeloffset);
mech.link(2)=createmechobject('link','r','link(1).x1','link(1).y1',a3,'theta13',1,'r',silent,3,labels{lblidx(3)},labeloffset);
mech.link(3)=createmechobject('link','r',a1,0,a4,'theta14',1,'y',silent,5,labels{lblidx(4)},labeloffset);
mech.link(4)=createmechobject('link','c',0,0,a1,0,1,'b',silent,0,labels{lblidx(1)}),labeloffset;
...
return
movie2avi(Frm,'double_rocker_as_crank_rocker.avi',15)
