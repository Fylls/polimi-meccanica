...
Nrevolutions=1;
theta13_start=pi/12;
theta13_range=2*pi*Nrevolutions;
theta13_inc_deg=5;
dtheta13=theta13_inc_deg*pi/180;
Npoints=floor(360/theta13_inc_deg*Nrevolutions);

[symb,X]=initvariables('theta12',theta12,'theta14',theta14,'theta13',theta13_start);
...
mech.hinge(2)=createmechobject('hinge',a1,0,1/2,'w',silent);
mech.link(1)=createmechobject('link','r',0,0,a2,'theta12',1,'b',silent,1,labels{lblidx(2)},labeloffset);
mech.link(2)=createmechobject('link','r','link(1).x1','link(1).y1',a3,'theta13',1,'g',silent,2,labels{lblidx(3)},labeloffset);
mech.link(3)=createmechobject('link','r',a1,0,a4,'theta14',1,'r',silent,3,labels{lblidx(4)},labeloffset);
mech.link(4)=createmechobject('link','c',0,0,a1,0,1,'y',silent,0,labels{lblidx(1)},labeloffset);
...
%%
for i=0:Npoints,
    theta13=theta13_start+i*dtheta13;
    th13(i+1)=theta13;
    [X,k]=solvemech(@doublerocker4bar,X,epsilonE,epsilonS,maxiter,[],theta13,a1,a2,a3,a4);
...
return
movie2avi(Frm,'double_rocker.avi',15)
