...
mech.link(2)=createmechobject('link','r','link(1).x1','link(1).y1',a3,'theta13',1,'g',silent,3,labels{lblidx(3)});
mech.link(3)=createmechobject('link','r',a1,0,a4,'theta14',1,'r',silent,1,labels{lblidx(4)});
mech.link(4)=createmechobject('link','c',0,0,a1,0,1,'y',silent,0,labels{lblidx(1)});
...
return
movie2avi(Frm,'change_point1.avi',15)
% figure
% subplot(2,1,1)
% plot(th12*180/pi,th14)
% subplot(2,1,2)
% plot(th12*180/pi,th13)
